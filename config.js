...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'public bot' : process.env.ALL_CAPTION,
    ...
    YAK: process.env.MAAN === undefined ? '918921483992,0' : process.env.MAAN, //dont change thise , if you change this some plugins created by me might not work for others or might have error ( bcoz this is a api key )
    BRANCH: 'master',
    HEROKU: {
