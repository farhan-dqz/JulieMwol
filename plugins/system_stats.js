...
//codded by afnanplk
        await message.client.sendMessage(message.jid, Buffer.from(plk_alive.data), MessageType.image, {mimetype: Mimetype.png, caption: Config.ALIVEMSG.replace('{time}', afn_plk_).replace('{qt}', r_text[i])})
	   }
    }));
