...
if (Config.WORKTYPE == 'private') {
    ...
    RAVANA.addCommand({ pattern: 'rbook ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
    ...
    RAVANA.addCommand({ pattern: 'rbook ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
