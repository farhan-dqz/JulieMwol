...
Asena.addCommand({pattern: 'underwater ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '```PLK-DQZ```'})
...
Asena.addCommand({pattern: 'snow ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
 ...
 Asena.addCommand({pattern: 'candlemug ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '```Made by PLK-DQZ```'})
  ...
  var topText, bottomText;
   ...
   Asena.addCommand({pattern: 'infohentai', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
		await message.sendMessage('🔞 DRAWN HENTAI 🔞\n\n 💦 *.hendxya* \n 💦 *.pantiexya* \n 💦 *.mastxya* \n 💦 *.catxya*');
	}));

	Asena.addCommand({ pattern: 'hentxya', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
		var drkhent = await axios.get(`https://api.xteam.xyz/randomimage/hentai?APIKEY=E67bd1bafe81b611`, { responseType: 'arraybuffer' })
		await message.sendMessage(Buffer.from(drkhent.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'nallath cheythal nallath kittane' })
	}));

	Asena.addCommand({ pattern: 'pantiexya', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
		var drkhent = await axios.get(`https://api.xteam.xyz/randomimage/panties?APIKEY=E67bd1bafe81b611`, { responseType: 'arraybuffer' })
		await message.sendMessage(Buffer.from(drkhent.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'nallath cheythal nallath kittane' })
	}));

	Asena.addCommand({ pattern: 'mastxya', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
		var drkhent = await axios.get(`https://api.xteam.xyz/randomimage/mstrb?APIKEY=E67bd1bafe81b611`, { responseType: 'arraybuffer' })
		await message.sendMessage(Buffer.from(drkhent.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'nallath cheythal nallath kittane' })
	}));

	Asena.addCommand({ pattern: 'catxya', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'PLK-DQZ'})
      ...
      Asena.addCommand({pattern: 'bpink ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);

    var webimage = await axios.get(`https://api.zeks.xyz/api/logobp?apikey=Ekqqy3DmxtTHPAuA7inIHpxjFIC&text=${match[1]}`, { responseType: 'arraybuffer' })

   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'PLK-DQZ'})

}));

     Asena.addCommand({pattern: '2neon ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);

    var webimage = await axios.get(`https://api.zeks.xyz/api/tlight?apikey=Ekqqy3DmxtTHPAuA7inIHpxjFIC&text=${match[1]}`, { responseType: 'arraybuffer' })

   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'PLK-DQZ'})

}));

    Asena.addCommand({pattern: 'ffire ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'neonglow ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'snow ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'DQZ-PLK  '})
 ...
 Asena.addCommand({pattern: 'candlemug ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '```DQZ-PLK```'})
    ...
    Asena.addCommand({pattern: 'wanted ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'google ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '```DQZ-PLK```'})
    ...
    Asena.addCommand({pattern: 'coffeecup ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'fire ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'banner ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
   ...
   Asena.addCommand({pattern: 'infohentai', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
	...
	Asena.addCommand({ pattern: 'hentxya', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
		var drkhent = await axios.get(`https://api.xteam.xyz/randomimage/hentai?APIKEY=E67bd1bafe81b611`, { responseType: 'arraybuffer' })
		await message.sendMessage(Buffer.from(drkhent.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'nallath cheythal nallath kittane' })
	}));

	Asena.addCommand({ pattern: 'pantiexya', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
		var drkhent = await axios.get(`https://api.xteam.xyz/randomimage/panties?APIKEY=E67bd1bafe81b611`, { responseType: 'arraybuffer' })
		await message.sendMessage(Buffer.from(drkhent.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'nallath cheythal nallath kittane' })
	}));

	Asena.addCommand({ pattern: 'mastxya', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
		var drkhent = await axios.get(`https://api.xteam.xyz/randomimage/mstrb?APIKEY=E67bd1bafe81b611`, { responseType: 'arraybuffer' })
		await message.sendMessage(Buffer.from(drkhent.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'nallath cheythal nallath kittane' })
	}));

	Asena.addCommand({ pattern: 'catxya', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
		var drkhent = await axios.get(`https://api.xteam.xyz/randomimage/pussy?APIKEY=E67bd1bafe81b611`, { responseType: 'arraybuffer' })
		await message.sendMessage(Buffer.from(drkhent.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'nallath cheythal nallath kittane' })
}));
    ...
    var webimage = await axios.get(`https://api.zeks.xyz/api/text3dbox?apikey=1hroZ3ju94h0PBjCNKsfhYaSuLs&text=${match[1]}`, { responseType: 'arraybuffer' })

   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'DQZ-PLK'})

}));
       
      Asena.addCommand({pattern: 'bpink ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);

    var webimage = await axios.get(`https://api.zeks.xyz/api/logobp?apikey=1hroZ3ju94h0PBjCNKsfhYaSuLs&text=${match[1]}`, { responseType: 'arraybuffer' })

   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'DQZ-PLK'})

}));

     Asena.addCommand({pattern: '2neon ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);

    var webimage = await axios.get(`https://api.zeks.xyz/api/tlight?apikey=1hroZ3ju94h0PBjCNKsfhYaSuLs&text=${match[1]}`, { responseType: 'arraybuffer' })

   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'DQZ-PLK'})

}));

    Asena.addCommand({pattern: 'ffire ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);

    var webimage = await axios.get(`https://api.zeks.xyz/api/epep?apikey=1hroZ3ju94h0PBjCNKsfhYaSuLs&text=${match[1]}`, { responseType: 'arraybuffer' })
