...
if (Config.WORKTYPE == 'private') {
    ...
    RAVANA.addCommand({ pattern: 'rbneon ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
    ...
    RAVANA.addCommand({ pattern: 'rbneon ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
