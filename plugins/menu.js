...
Asena.addCommand({pattern: 'menu', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    r_text[0] = "https://www.pixelstalk.net/wp-content/uploads/2016/03/Professor-wallpaper-HD-dowload.jpg";
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `⛦━━━━━✨️ANS ANSHIF✨️━━━━━⛦


𝐇𝐞𝐥𝐥𝐨👋 𝐈 𝐚𝐦 𝐚 ANS ANSHIF 𝐛𝐨𝐭.
            *PROFESSOR*
