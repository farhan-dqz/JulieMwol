...
const lol = "need some word\n🗡🗡enthelum ezhuthu nenba"
    ...
    Asena.addCommand({ pattern: 'sophia ?(.*)', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'sophia ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
