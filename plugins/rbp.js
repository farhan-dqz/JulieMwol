...
if (Config.WORKTYPE == 'private') {
    ...
    RAVANA.addCommand({ pattern: 'rbp ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
    ...
    RAVANA.addCommand({ pattern: 'rbp ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
