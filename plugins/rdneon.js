...
if (Config.WORKTYPE == 'private') {
    ...
    RAVANA.addCommand({ pattern: 'rdneon ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
    ...
    RAVANA.addCommand({ pattern: 'rdneon ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
