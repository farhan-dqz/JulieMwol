...
const array = ['Hi','power','sad','Akash','anthas','failed','alla','chunk','marichu','myre','think','cheyalle','mention','mama','set','eda','umma','police','aysheri','vannu','love','manasilla','uyir','oombi','Mm','important','sed','chathu','girl','poweresh','ooo','bye','fuck','pedicho','kunna','number','ok','pwoli','chiri','vibe','shut','saved','mood','shaad','pidi']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
