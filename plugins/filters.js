...
await message.client.sendMessage(message.jid, fs.readFileSync('./stickers/song.webp'), MessageType.sticker, { mimetype: Mimetype.webp, quoted : message.data, ptt: false})
    }
