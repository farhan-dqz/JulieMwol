...
const array = ['Hii','ee','Da','food','Hlo','sachusamu','para','love u','set','sed','jada','Saidali','Hi','sad','don','Loki','nee','bye','ara','Goodnight','kittilla','Mm','Msd','Njan','nirtheda','nan','parupadi','pm','poda','podi','song','va','Aysheri','ha','set','Comady','ne','Uploding','mathi','e','Ponu','Hlo','Ara','vazha','Eda','ss creation','love','Hy']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
