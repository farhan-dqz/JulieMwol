...
const array = ['od','kalam','oi','sha','ma','ya','bomb','ee','machu','bgm','onn','mute','la','unmute','wait','k','apo','so','nee','oo','menu','list','ko','pa','sir','monu','chaya','night','po','army','poth','money','kayari','ip','bye','power','on','boss','nallath','adi','mari','patti','nyt','ser','Missing','mind','morning','set','Criminal','Entry','Thyr','Admin','kundan','ay','muthe','mass','its me','Cr7','Tone','Messi','item','Annan','Azaru','Ada','Hi','Hii','sad','Myre','Alive','Mrng','Da','WELCOME','Left','Link','Ok','Aliya','alive','Amal','help','Pova','Myr','setta','range','Mood','love','Ninde','you','poli','Happy','girl','Andi','chadhi']
array.map( async (a) => {
