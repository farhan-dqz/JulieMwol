...
if (Config.WORKTYPE == 'private') {
    ...
    RAVANA.addCommand({ pattern: 'rcrismes ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
    ...
    RAVANA.addCommand({ pattern: 'rcrismes ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
