...
if (Config.WORKTYPE == 'private') {
    ...
    RAVANA.addCommand({ pattern: 'ral ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
    ...
    RAVANA.addCommand({ pattern: 'ral ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
