...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [ss-creation-] --*' + 
                                    '\n*ss-creation- an error has occurred!*'+
                                    ...
                                    '\n*Aslo you can join our support group:* https://chat.whatsapp.com/LXQpjOuDf7IFUWJ1XoPFoT' +
                                    '\n*This message should have gone to your number (saved messages).*\n\n' +
                                    '*Error:* ```' + error + '```\n\n'
                                    , MessageType.text, {detectLinks: false}
                                );
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [ss-creation-] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
                                    ...
                                    return await conn.sendMessage(conn.user.jid, '*🙇🏻 Sorry, I Couldnt Read This Error! 🙇🏻*' +
                                        '\n_You can write to our support group for more help /nhttps://chat.whatsapp.com/LXQpjOuDf7IFUWJ1XoPFoT._'
                                        , MessageType.text
                                    );
                                }    
                            }                      
